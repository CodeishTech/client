...
export default function CreateArticle(){
  ...
  return (
    <div align="center" justify="center">
      ...
      <br/>
      {error!=="" &&
        <div className="w-1/3 text-red-700 bg-red-100 border border-red-700 px-4 py-3 rounded-lg absolute right-0 bottom-0 flex justify-start" role="alert">
      ...
      {success!=="" &&
        <div className="w-1/3 text-green-700 bg-green-100 border border-green-700 px-4 py-3 rounded-lg absolute right-0 bottom-0 flex justify-start" role="alert">
