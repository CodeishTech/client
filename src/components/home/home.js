        ...
        <div className="w-full md:w-1/2 p-6 md:px-24 md:py-20">
          <div className="flex justify-center pt-4">
            <div>
              ...
              <p className="font-medium text-green-500 mt-2 text-3xl lg:text-5xl md:text-4xl flex justify-center md:justify-start">on The Codeish</p>
              ...
              <div className="flex justify-center sm:justify-start space-x-7 sm:space-x-7 mt-6">
                <a href="https://www.facebook.com/CodeishTech/"   rel="noreferrer"><button className="p-1 md:p-1.5 border rounded border-gray-400 hover:border-orange-500 hover:border-dashed"><FontAwesomeIcon className="text-blue-600 text-2xl" icon={faFacebook} /></button></a>
                <a href="https://www.youtube.com/channel/UC4Atex7DLs0sDJ1Drj7kAEA/"   rel="noreferrer"><button className="p-1 md:p-1.5 border rounded border-gray-400 hover:border-orange-500 hover:border-dashed"><FontAwesomeIcon className="text-red-500 text-2xl" icon={faYoutube} /></button></a>
                <a href="https://www.linkedin.com/company/codeish/"   rel="noreferrer"><button className="p-1 md:p-1.5 border rounded border-gray-400 hover:border-orange-500 hover:border-dashed"><FontAwesomeIcon className="text-blue-400 text-2xl" icon={faLinkedinIn} /></button></a>
