                                ...
                                <div className="relative shadow shadow-white rounded w-full">
                                  ...
                                  <div className="w-full p-4">
                                    ...
                                    <div className="w-full flex flex-row justify-between">
                                      ...
                                      <Link to="/comingsoon"><button className={outlinedButton+" my-2 mt-3 text-white border-orange-500 rounded-md"}>Explore <FontAwesomeIcon icon={faArrowRight} /></button></Link>
                                    </div>
                                  </div>
                                </div>
                              </div>
