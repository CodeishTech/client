      ...
      <nav className="bg-navblue dark:bg-gray-900 border-t">
        <div className="md:flex px-2 md:px-16">
          <div className="w-full md:w-1/4 p-2 md:p-8 mt-4 md:mt-0">
            <center>
              <p className="text-4xl text-orange-500 font-semibold"><FontAwesomeIcon icon={faLaptopCode} /> Codeish</p>
          ...
          <div className="w-full md:w-1/4 p-2 md:p-8 mt-4 md:mt-0">
            <div className="flex md:justify-center">
              <div className=" flex-col">
                ...
                <a href="https://www.facebook.com/CodeishTech/" target="_blank" rel="noreferrer"><button className={textButton+" flex justify-center mt-5"}><FontAwesomeIcon className="mt-0.5 mr-2 text-lg" icon={faFacebook} /> Facebook</button></a>
                <a href="https://www.youtube.com/channel/UC4Atex7DLs0sDJ1Drj7kAEA/" target="_blank" rel="noreferrer"><button className={textButton+" flex justify-center mt-5"}><FontAwesomeIcon className="mt-0.5 mr-2 text-lg" icon={faYoutube} /> YouTube</button></a>
                <a href="https://www.linkedin.com/company/codeish/" target="_blank" rel="noreferrer"><button className={textButton+" flex justify-center mt-5"}><FontAwesomeIcon className="mt-0.5 mr-2 text-lg" icon={faLinkedin} /> Linkedin</button></a>
                <a href="https://www.instagram.com/codeish.tech/" target="_blank" rel="noreferrer"><button className={textButton+" flex justify-center mt-5"}><FontAwesomeIcon className="mt-0.5 mr-2 text-lg" icon={faInstagram} /> Instagram</button></a>
                <a href="https://twitter.com/CodeishTech" target="_blank" rel="noreferrer"><button className={textButton+" flex justify-center mt-5"}><FontAwesomeIcon className="mt-0.5 mr-2 text-lg" icon={faTwitter} /> Twitter</button></a>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/4 p-2 md:p-8 mt-4 md:mt-0">
